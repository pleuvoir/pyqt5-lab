...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # top dock
        dock = QDockWidget("Window0", self)
        textEdit = QTextEdit()
        textEdit.setText("top dock")
        ...
        textEdit = QTextEdit()
        textEdit.setText(
            "Window2,The dock widget can be detac from the main window,""and float as an independent window,and can be closed")
        dock.setWidget(textEdit)
